...
export default function Recommended() {
        ...
        const [hostelsPerPage] = useState(6);
         const [filterHeading] = useState('Recommended Hostels');
    const recommendedHostels = [
        ...
        const currentHostels = recommendedHostels.slice(indexOfFirstHostel, indexOfLastHostel);
  ...
  return (
    ...
    <Sidebar/>
      ...
      <div className="hostel-cards">
        ...
        {Array.from({ length: Math.ceil(recommendedHostels.length / hostelsPerPage) }, (_, i) => (
