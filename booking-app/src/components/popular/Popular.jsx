...
export default function PopularHostels() {
    ...
    const [hostelsPerPage] = useState(6);
     const [filterHeading] = useState('Popular Hostels');
  ...
  const currentHostels = popularHostels.slice(indexOfFirstHostel, indexOfLastHostel);
  ...
  return (
    ...
    <Sidebar/>
      ...
      <div className="hostel-cards">
        ...
        {Array.from({ length: Math.ceil(popularHostels.length / hostelsPerPage) }, (_, i) => (
